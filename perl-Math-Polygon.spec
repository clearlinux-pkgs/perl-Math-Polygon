...
Version  : 1.11
Release  : 28
URL      : https://cpan.metacpan.org/authors/id/M/MA/MARKOV/Math-Polygon-1.11.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/M/MA/MARKOV/Math-Polygon-1.11.tar.gz
...
%prep
%setup -q -n Math-Polygon-1.11
cd %{_builddir}
tar xf %{_sourcedir}/libmath-polygon-perl_1.10-1.debian.tar.xz
cd %{_builddir}/Math-Polygon-1.11
mkdir -p deblicense/
cp -r %{_builddir}/debian/. %{_builddir}/Math-Polygon-1.11/deblicense/
